...
export default function ContactSection() {
  ...
  return (
    <div className="w-full z-10 bg-white relative  h-screen px-5 md:px-10 lg:px-40 flex flex-col justify-center items-center">
      <div className="w-full grid grid-cols-1 md:grid-cols-2 mt-10 md:w-[50rem] md:h-[40rem] mb-10">
        <div className="w-full flex flex-col gap-2 pr-5">
          {/* Heading */}
          <div>
            <span className="text-3xl tracking-wide text-transparent bg-clip-text bg-gradient-to-br from-indigo-400 to-purple-500 font-mono">
              CONTACT ME{" "}
            </span>
          </div>
          <p className="text-lg text-black/50">
            Want to ask a question or start working with me? Just fill the form
            below!
          </p>
          ...
          <div className="h-full py-5">
            ...
            >
                      ...
                      {
                        {
                          ...
                          sending: (
                            <AiOutlineLoading3Quarters className="h-4 w-4 animate-spin"></AiOutlineLoading3Quarters>
                          ),
              ...
              <motion.p
                ref={statusText}
                initial={{ y: 20 }}
                className="flex gap-2 items-center text-black/50"
              >
                {
                  {
                    sent: (
                    ...
                    error: (
                      <>
                        <BsExclamationSquareFill className="h-4 w-4"></BsExclamationSquareFill>
                        An error occured. Check your data and try submitting
                        again.
                      </>
                    ),
                  }[status]
